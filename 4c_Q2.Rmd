...
###localhost
pts<-st_read("Y:/people/spreto/2001_WIND_OPTIM/spat_pts_201204/B3_FOR+.shp")
...
pareto<-subset(pareto,pareto$MODEL_RUN==201210)
tmp_dat<-subset(pareto,pareto$RESTRICTION == "restrictive")
# restrictive scen
