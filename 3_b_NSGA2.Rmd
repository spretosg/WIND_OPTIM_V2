...
MU = 100; LAMBDA = MU-40;  MAX.ITER =60000
 ...
 # cen<-cen[c(1:300),]
  ...
  if(sum(cen$prod_MW)<low_targ | bound_up>1){
    ...
    for(i in seq_len(MAX.ITER)){
      ...
      offspring<-generateOffspring(ctrl, population, fitness, LAMBDA, p.recomb = 0.7, p.mut = 0.4)
    ...
    #save HV curve
    jpeg(file="D:/04_PROJECTS/2001_WIND_OPTIM/WIND_OPTIM_git/intermediate_steps/3_wp/OPTIM_RES/HV_curves/rec_07_mutprob04_MU40_HV.jpg",width = 500, height = 300)
    plot(stats)
    dev.off()
    ...
    cen<-st_as_sf(cen)
    st_write(obj = cen, dsn = con, Id(schema="optim_res_201022", table = as.character(paste(scen_names[a,],"_60k_1027",sep=""))))
