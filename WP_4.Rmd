...
a<-subset(in_dat,in_dat$SCENARIO=="B2_HZ++")
b<-subset(in_dat,in_dat$SCENARIO=="B2_HZ+")
both<-rbind(a,b)
...
leveneTest(base$mean_MWH.yHA,NOT_IN_FOR$mean_MWH.yHA) #homogeneity of variance
