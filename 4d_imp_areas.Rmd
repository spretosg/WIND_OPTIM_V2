...
```{r}
tmpA<-rob_pts
tmpB<-st_read("D:/04_PROJECTS/2001_WIND_OPTIM/WIND_OPTIM_git/intermediate_steps/4_wp/pts_sel_210112/CRF.shp")
...
tmp_plot<-ggplot(data = bound) +
    ...
    geom_sf(data = joined, color="red", alpha = .2, size=joined$diff2)+
